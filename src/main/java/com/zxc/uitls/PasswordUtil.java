...
public class PasswordUtil {
     ...
     * * @return byte[] 盐值	 *
     */
    public static byte[] getSalt() throws Exception {        //实例化安全随机数
        SecureRandom random = new SecureRandom();        //产出盐
    ...
    public static boolean matches(String salt,String psd,String pass) throws Exception {
//        String s=encrypt(psd,"01234567",salt.getBytes());
        return psd.equals(pass);
    }
}